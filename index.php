...
<body>
    <div class="main_container position-relative .min_vh_100 h-100">
        ...
        <main class="position-relative">
            ...
            <div class="background_container position-absolute h-100 w-100 ">
                ...
                <!-- hills  -->
                <img class="third_hill w-100 position-absolute" src="./assets/img/Vector 5.png" alt="">
                <img class="second_hill w-100 position-absolute " src="./assets/img/Vector 4.png" alt="">
                <img class="white_plain w-100 position-absolute bottom-0 " src="./assets/img/Vector 1.png" alt="">
                <!-- planets  -->
                <div class="big_planet"></div>
                <div class="small_planet d-none d-sm-block"></div>
                <!-- starship  -->
                <svg class="starship position-absolute" width="111" height="185" viewBox="0 0 111 185" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="  form_container position-relative d-flex w-100 align-items-center flex-column p-md-3">
                <h1 class="pt-5 pb-2">Crea il tuo account</h1>
                <form action="" method="POST" class="bg-white col-12  col-md-8 col-lg-6">
                    <div class="w-100">
                        ...
                        <input id="name" type="text" placeholder="Mario">
                    </div>
                    <div class="w-100">
                        <label for="last_name">Inserisci il cognome</label>
                        <input id="last_name" type="text" placeholder="Rossi">
                    </div>
                    <div class="w-100">
                        <label for="email">Inserisci l'email</label>
                        <input id="email" type="email" placeholder="name@examplw.com">
                    </div>
                    <div class="w-100">
                        <label for="pasword">Inserisci la pasword</label>
                        <div class="pasword_container d-flex align-items-center">
                            <input class="d-inline" id="pasword" type="text" placeholder="Scrivila qui">
            ...
            <!-- FORM LOG IN -->
            <div class="d-none form_container position-relative d-flex w-100  align-items-center flex-column p-md-3">
                <h1 class="pt-5 pb-2">Crea il tuo account</h1>
                <form action="" method="POST" class="bg-white col-12 col-md-8 col-lg-6">
                    <div class="w-100">
                        <label for="email">Inserisci l'email</label>
            ...
            <!-- EVENTS -->
            <div class="d-none form_container position-relative d-flex w-100  align-items-center flex-column ">
                <h1 class="pt-5  pb-2 text-center">Ciao NOME ecco i tuoi eventi</h1>
