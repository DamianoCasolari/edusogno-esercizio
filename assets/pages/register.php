...
<div class="  form_container position-relative d-flex w-100 align-items-center flex-column p-md-3">
    ...
    <form action="" method="POST" class="bg-white col-12  col-md-8 col-lg-6">
        ...
        <div class="w-100">
            ...
            <input id="email" name="email" type="email" placeholder="name@examplw.com" required>
        </div>
        <div class="w-100">
            <label for="password">Inserisci la password</label>
            <div class="password_container d-flex align-items-center">
                <input class="d-inline w-100 border-0" name="password" id="password" type="password" placeholder="Scrivila qui" required>
